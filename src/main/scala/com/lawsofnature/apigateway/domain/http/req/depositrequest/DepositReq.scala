...
package com.lawsofnature.apigateway.domain.http.req.depositrequest
...
final case class DepositReq(
  ...
  def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.lawsofnature.apigateway.domain.http.req.depositrequest.DepositReq = {
    ...
    com.lawsofnature.apigateway.domain.http.req.depositrequest.DepositReq(
  ...
  def companion = com.lawsofnature.apigateway.domain.http.req.depositrequest.DepositReq
}

object DepositReq extends com.trueaccord.scalapb.GeneratedMessageCompanion[com.lawsofnature.apigateway.domain.http.req.depositrequest.DepositReq] {
  implicit def messageCompanion: com.trueaccord.scalapb.GeneratedMessageCompanion[com.lawsofnature.apigateway.domain.http.req.depositrequest.DepositReq] = this

  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.lawsofnature.apigateway.domain.http.req.depositrequest.DepositReq = {
  ...
  lazy val defaultInstance = com.lawsofnature.apigateway.domain.http.req.depositrequest.DepositReq(
  )

  implicit class DepositReqLens[UpperPB](_l: _root_.com.trueaccord.lenses.Lens[UpperPB, com.lawsofnature.apigateway.domain.http.req.depositrequest.DepositReq]) extends _root_.com.trueaccord.lenses.ObjectLens[UpperPB, com.lawsofnature.apigateway.domain.http.req.depositrequest.DepositReq](_l) {
