...
final case class Channel(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.lawsofnature.apigateway.domain.http.resp.channellist.Channel = {
      ...
      com.lawsofnature.apigateway.domain.http.resp.channellist.Channel(
          code = __code,
          name = __name,
          ext1 = __ext1,
          ext2 = __ext2,
    ...
    def companion = com.lawsofnature.apigateway.domain.http.resp.channellist.Channel
}

object Channel extends com.trueaccord.scalapb.GeneratedMessageCompanion[com.lawsofnature.apigateway.domain.http.resp.channellist.Channel] {
  implicit def messageCompanion: com.trueaccord.scalapb.GeneratedMessageCompanion[com.lawsofnature.apigateway.domain.http.resp.channellist.Channel] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.lawsofnature.apigateway.domain.http.resp.channellist.Channel = {
  ...
  lazy val defaultInstance = com.lawsofnature.apigateway.domain.http.resp.channellist.Channel(
  )
  implicit class ChannelLens[UpperPB](_l: _root_.com.trueaccord.lenses.Lens[UpperPB, com.lawsofnature.apigateway.domain.http.resp.channellist.Channel]) extends _root_.com.trueaccord.lenses.ObjectLens[UpperPB, com.lawsofnature.apigateway.domain.http.resp.channellist.Channel](_l) {
