...
final case class SimpleApiResponse(
    ...
    private[this] def __computeSerializedValue(): Int = {
      ...
      if (ext1 != "") { __size += _root_.com.google.protobuf.CodedOutputStream.computeStringSize(2, ext1) }
      if (ext2 != "") { __size += _root_.com.google.protobuf.CodedOutputStream.computeStringSize(3, ext2) }
      if (ext3 != "") { __size += _root_.com.google.protobuf.CodedOutputStream.computeStringSize(4, ext3) }
      if (ext4 != "") { __size += _root_.com.google.protobuf.CodedOutputStream.computeStringSize(5, ext4) }
      if (ext5 != "") { __size += _root_.com.google.protobuf.CodedOutputStream.computeStringSize(6, ext5) }
      __size
    }
