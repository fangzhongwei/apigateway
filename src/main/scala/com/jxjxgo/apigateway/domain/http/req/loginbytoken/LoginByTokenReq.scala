...
final case class LoginByTokenReq(
                                  ...
                                  ext4: String = "",
                                  ext5: String = ""
                                ) extends com.trueaccord.scalapb.GeneratedMessage with com.trueaccord.scalapb.Message[LoginByTokenReq] with com.trueaccord.lenses.Updatable[LoginByTokenReq] {
  @transient
  ...
  def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.jxjxgo.apigateway.domain.http.req.loginbytoken.LoginByTokenReq = {
    ...
    com.jxjxgo.apigateway.domain.http.req.loginbytoken.LoginByTokenReq(
      clientId = __clientId,
      version = __version,
  ...
  def withFingerPrint(__v: String): LoginByTokenReq = copy(fingerPrint = __v)

  def withToken(__v: String): LoginByTokenReq = copy(token = __v)

  def withExt1(__v: String): LoginByTokenReq = copy(ext1 = __v)

  def withExt2(__v: String): LoginByTokenReq = copy(ext2 = __v)

  def withExt3(__v: String): LoginByTokenReq = copy(ext3 = __v)

  def withExt4(__v: String): LoginByTokenReq = copy(ext4 = __v)

  def withExt5(__v: String): LoginByTokenReq = copy(ext5 = __v)
  ...
  def companion = com.jxjxgo.apigateway.domain.http.req.loginbytoken.LoginByTokenReq
}

object LoginByTokenReq extends com.trueaccord.scalapb.GeneratedMessageCompanion[com.jxjxgo.apigateway.domain.http.req.loginbytoken.LoginByTokenReq] {
  implicit def messageCompanion: com.trueaccord.scalapb.GeneratedMessageCompanion[com.jxjxgo.apigateway.domain.http.req.loginbytoken.LoginByTokenReq] = this

  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.jxjxgo.apigateway.domain.http.req.loginbytoken.LoginByTokenReq = {
  ...
  lazy val defaultInstance = com.jxjxgo.apigateway.domain.http.req.loginbytoken.LoginByTokenReq(
  )

  implicit class LoginByTokenReqLens[UpperPB](_l: _root_.com.trueaccord.lenses.Lens[UpperPB, com.jxjxgo.apigateway.domain.http.req.loginbytoken.LoginByTokenReq]) extends _root_.com.trueaccord.lenses.ObjectLens[UpperPB, com.jxjxgo.apigateway.domain.http.req.loginbytoken.LoginByTokenReq](_l) {
