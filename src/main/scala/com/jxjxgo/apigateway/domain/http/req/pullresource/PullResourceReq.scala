...
package com.jxjxgo.apigateway.domain.http.req.pullresource
...
final case class PullResourceReq(
  ...
  def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.jxjxgo.apigateway.domain.http.req.pullresource.PullResourceReq = {
    ...
    com.jxjxgo.apigateway.domain.http.req.pullresource.PullResourceReq(
      version = __version,
      lan = __lan,
      ext1 = __ext1,
      ext2 = __ext2,
  ...
  def companion = com.jxjxgo.apigateway.domain.http.req.pullresource.PullResourceReq
}

object PullResourceReq extends com.trueaccord.scalapb.GeneratedMessageCompanion[com.jxjxgo.apigateway.domain.http.req.pullresource.PullResourceReq] {
  implicit def messageCompanion: com.trueaccord.scalapb.GeneratedMessageCompanion[com.jxjxgo.apigateway.domain.http.req.pullresource.PullResourceReq] = this

  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.jxjxgo.apigateway.domain.http.req.pullresource.PullResourceReq = {
  ...
  lazy val defaultInstance = com.jxjxgo.apigateway.domain.http.req.pullresource.PullResourceReq(
  )

  implicit class PullResourceReqLens[UpperPB](_l: _root_.com.trueaccord.lenses.Lens[UpperPB, com.jxjxgo.apigateway.domain.http.req.pullresource.PullResourceReq]) extends _root_.com.trueaccord.lenses.ObjectLens[UpperPB, com.jxjxgo.apigateway.domain.http.req.pullresource.PullResourceReq](_l) {
