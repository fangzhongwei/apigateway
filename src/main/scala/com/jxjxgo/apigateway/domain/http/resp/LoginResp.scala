...
final case class LoginResp(
  ...
  private[this] def __computeSerializedValue(): Int = {
    ...
    if (token != "") {
      __size += _root_.com.google.protobuf.CodedOutputStream.computeStringSize(2, token)
    }
    if (mobile != "") {
      __size += _root_.com.google.protobuf.CodedOutputStream.computeStringSize(3, mobile)
    }
    if (status != 0) {
      __size += _root_.com.google.protobuf.CodedOutputStream.computeInt32Size(4, status)
    }
    if (nickName != "") {
      __size += _root_.com.google.protobuf.CodedOutputStream.computeStringSize(5, nickName)
    }
    if (ext1 != "") {
  ...
  def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.jxjxgo.apigateway.domain.http.resp.LoginResp = {
    ...
    com.jxjxgo.apigateway.domain.http.resp.LoginResp(
      code = __code,
      token = __token,
      mobile = __mobile,
      status = __status,
  ...
  def withExt3(__v: String): LoginResp = copy(ext3 = __v)

  def withExt4(__v: String): LoginResp = copy(ext4 = __v)

  def withExt5(__v: String): LoginResp = copy(ext5 = __v)
  ...
  def companion = com.jxjxgo.apigateway.domain.http.resp.LoginResp
}

object LoginResp extends com.trueaccord.scalapb.GeneratedMessageCompanion[com.jxjxgo.apigateway.domain.http.resp.LoginResp] {
  implicit def messageCompanion: com.trueaccord.scalapb.GeneratedMessageCompanion[com.jxjxgo.apigateway.domain.http.resp.LoginResp] = this

  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.jxjxgo.apigateway.domain.http.resp.LoginResp = {
  ...
  lazy val defaultInstance = com.jxjxgo.apigateway.domain.http.resp.LoginResp(
  )

  implicit class LoginRespLens[UpperPB](_l: _root_.com.trueaccord.lenses.Lens[UpperPB, com.jxjxgo.apigateway.domain.http.resp.LoginResp]) extends _root_.com.trueaccord.lenses.ObjectLens[UpperPB, com.jxjxgo.apigateway.domain.http.resp.LoginResp](_l) {
