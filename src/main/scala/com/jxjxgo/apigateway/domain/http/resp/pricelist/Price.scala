...
final case class Price(
  ...
  private[this] def __computeSerializedValue(): Int = {
    ...
    if (diamondAmount != 0) {
      __size += _root_.com.google.protobuf.CodedOutputStream.computeInt32Size(2, diamondAmount)
    }
    if (price != "") {
  ...
  def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.jxjxgo.apigateway.domain.http.resp.pricelist.Price = {
    ...
    com.jxjxgo.apigateway.domain.http.resp.pricelist.Price(
      code = __code,
  ...
  def companion = com.jxjxgo.apigateway.domain.http.resp.pricelist.Price
}

object Price extends com.trueaccord.scalapb.GeneratedMessageCompanion[com.jxjxgo.apigateway.domain.http.resp.pricelist.Price] {
  implicit def messageCompanion: com.trueaccord.scalapb.GeneratedMessageCompanion[com.jxjxgo.apigateway.domain.http.resp.pricelist.Price] = this

  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.jxjxgo.apigateway.domain.http.resp.pricelist.Price = {
  ...
  lazy val defaultInstance = com.jxjxgo.apigateway.domain.http.resp.pricelist.Price(
  )

  implicit class PriceLens[UpperPB](_l: _root_.com.trueaccord.lenses.Lens[UpperPB, com.jxjxgo.apigateway.domain.http.resp.pricelist.Price]) extends _root_.com.trueaccord.lenses.ObjectLens[UpperPB, com.jxjxgo.apigateway.domain.http.resp.pricelist.Price](_l) {
